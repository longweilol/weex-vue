     ...
     <loginHeader :data="data"></loginHeader> 
      <div class="register_out bg_white">
            ...
            <div class="input_wrapper">  
                <input class="input bg_gray"  placeholder="手机号" value="" v-model="mobileNo" type="tel" maxlength="11"/>  
                <image class="input_img" :src="get_img_path('mobile.png')"></image>  
            </div>
            <div class="input_wrapper send_code_out">  
                <div class="input_code_out">
                    <input class="input_code bg_gray"  :autofocus="vcodeFocus" type="tel" maxlength="6" placeholder="手机验证码" value="" v-model="vCode"/>  
                    <image class="input_img" :src="get_img_path('correct.png')"></image>  
                </div>
                <div class="input_code_btn">
                     <text class="send_code" :class="[datatime.judgetime?'send_btn_on':'send_btn_off']"  @click="sendCode()">{{datatime.timetext}}</text>  
                </div>

            </div>  
           <div class="hint_out"  @click="jump('/login')"><text class="hint_pwdlogin color1">账号密码登录</text></div>
            <div class="input_wrapper">  
                <div class="input_register"  @click="goModifyPwd()">  
